...
function Draggable(props: PlateElementProps) {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <Button
                ...
                variant="ghost"
                className={cn(
                  "absolute -left-0 h-6 w-full p-0 rounded-sm",
      ...
      <div
        ref={previewRef}
                  className={cn('absolute -left-0 hidden w-fit pointer-events-none')}
        style={{
          top: `${-previewTop}px`,
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <div
          ...
          role="button"
        >
          <GripVertical className="size-4 text-muted-foreground hover:text-foreground transition-colors duration-200" />
        </div>
      </TooltipTrigger>
            <TooltipContent
        side="left"
        className="text-xs px-2 py-1 bg-gray-800 text-white border-gray-700"
      >
        Drag to move
      </TooltipContent>
    </Tooltip>
...
const DropLine = React.memo(function DropLine({
  ...
  return (
    <div
      ...
      className={cn(
        'slate-dropLine',
        'absolute inset-x-0 h-2 opacity-100 transition-opacity duration-200',
        'bg-white shadow-lg rounded-sm z-50',
        'animate-in fade-in duration-200',
        dropLine === 'top' && '-top-1',
        dropLine === 'bottom' && '-bottom-1',
        className
      )}
    />
  );
